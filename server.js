...
// Mess — shared daily food/cooking expenses for a group of friends
// (invite code to join, menu, ingredients/purchases, per-head split).
app.use('/api/mess', requireFeature('mess'), require('./routes/mess'));
