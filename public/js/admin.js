...
const FEATURE_META = {
  ...
  mess:        { label: 'Mess (shared food)',icon: 'ti-tools-kitchen-2' },
};
...
const RESOURCE_LABELS = {
  ...
  market: 'Market data', 'admin-users': 'Admin — user management', mess: 'Mess',
};
...
function openDeleteModal(id) {
  ...
  document.getElementById('deleteUserMessage').textContent =
    `Delete ${u.full_name || u.username}? This permanently removes their account and every entry they created (loans, rent, bills, expenses, savings, committees, investments, salary, mess). This can't be undone.`;
