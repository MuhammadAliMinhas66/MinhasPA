...
module.exports = {
  ...
  MessGroup: require('./MessGroup'),
  MessMember: require('./MessMember'),
  MessMenu: require('./MessMenu'),
  MessAttendance: require('./MessAttendance'),
  MessExpense: require('./MessExpense'),
  MessTask: require('./MessTask'),
  MessContribution: require('./MessContribution'),
};
